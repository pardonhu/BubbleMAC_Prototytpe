...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        try:
            os.remove('/home/hu/Desktop/2_wifi.pcap')
            print('Orinial file removed!')
            os.mkfifo('/home/hu/Desktop/2_wifi.pcap')
        except:
            os.mkfifo('/home/hu/Desktop/2_wifi.pcap')
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/hu/Desktop/memory_file_sys/wifi.pcap', False)
...
def main(top_block_cls=wifi_rx, options=None):
    ...
    # test.main(gps_serial_path='/dev/ttyUSB0',\
    #           stm_serial_path='/dev/ttyUSB1')
    gps_serial_path, stm_serial_path ='/dev/ttyUSB2', '/dev/ttyUSB0'
    ser_stm,ret_stm=communicate.DOpenPort(stm_serial_path,115200,None)
    # ser_gps,ret_gps=communicate.GPSOpenPort(gps_serial_path,115200,None)
    communicate.ReadPcap(ser_stm)
