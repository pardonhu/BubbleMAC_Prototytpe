...
class wifi_trx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/hu/Desktop/memory_file_sys/wifi.pcap', True)
...
def packet_transmit(tb):
    ...
    packet_log = open(f'/home/hu/Desktop/memory_file_sys/packet_log/{cur_time}.txt', 'w')
    try:
        while(packet_num < 1000):
            ...
            msg = '  Rear ' + str(packet_num).zfill(5) + ' ' + '{:.3f}'.format(communicate.front_dist) + ' ' + '{:.3f}'.format(communicate.vel_cur)
            print(f'msg: {msg}')
            msg = pmt.intern(msg)
...
def main(top_block_cls=wifi_trx, options=None):
    ...
    while True:
        pass
    # try:
    #     os.remove('/home/hu/Desktop/memory_file_sys/wifi.pcap')
    #     print('Orinial file removed!')
    # except Exception as e:
    #     print(f'remove error: {e}')
    #     f = open('/home/hu/Desktop/memory_file_sys/wifi.pcap', 'rb')
    #     f.close()
