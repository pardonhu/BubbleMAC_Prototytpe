...
class wifi_tx2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Wifi Tx2")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Wifi Tx2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "wifi_tx2")
        ...
        self.foo_packet_pad2_0 = foo.packet_pad2(False, False, 0.02, 1000, 1000)
...
def main(top_block_cls=wifi_tx2, options=None):
