...
class wifi_rx_demo(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Wifi Rx Demo")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Wifi Rx Demo")
        ...
        self.settings = Qt.QSettings("GNU Radio", "wifi_rx_demo")
        ...
        self.ieee802_11_sync_short_0 = ieee802_11.sync_short(0.72, 14, False, False)
        ...
        self.ieee802_11_frame_equalizer_0 = ieee802_11.frame_equalizer(ieee802_11.LS, freq, samp_rate, False, False)
        self.ieee802_11_decode_mac_0 = ieee802_11.decode_mac(False, False)
        self._gain_range = Range(0, 1, 0.01, 0.13, 200)
        ...
        self.blocks_file_source_1 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/hu/Desktop/memory_file_sys/wifi_demo', True, 0, 0)
        self.blocks_file_source_1.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/hu/Desktop/memory_file_sys/wifi_fifo.pcap', True)
        ...
        self.connect((self.blocks_file_source_1, 0), (self.blocks_complex_to_mag_squared_0, 0))
        self.connect((self.blocks_file_source_1, 0), (self.blocks_delay_0_0, 0))
        ...
        self.connect((self.blocks_pdu_to_tagged_stream_1, 0), (self.blocks_null_sink_0, 0))
...
def main(top_block_cls=wifi_rx_demo, options=None):
