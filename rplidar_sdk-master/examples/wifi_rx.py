...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._threshold_range = Range(0, 1, 0.01, 0.72, 200)
        ...
        self._plateau_range = Range(3, 16, 1, 14, 200)
        self._plateau_win = RangeWidget(self._plateau_range, self.set_plateau, 'plateau', "counter_slider", float)
        self.top_layout.addWidget(self._plateau_win)
        # Create the options list
        ...
        self._gain_range = Range(0, 1, 0.01, 0.2, 200)
        ...
        self.ieee802_11_sync_short_0 = ieee802_11.sync_short(threshold, plateau, False, False)
