...
class wifi_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._tx_gain_range = Range(0, 1, 0.01, 0.66, 200)
        ...
        self._interval_range = Range(10, 1000, 1, 200, 200)
        ...
        self.connect((self.foo_packet_pad2_0, 0), (self.blocks_null_sink_0, 0))
