...
class tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._gain_range = Range(0, 1, 0.1, 0.5, 200)
        ...
        self.uhd_usrp_sink_0_1.set_normalized_gain(gain, 0)
        self.uhd_usrp_sink_0_1.set_antenna('TX/RX', 0)
        self.uhd_usrp_sink_0_1.set_bandwidth(10000000, 0)
        ...
        # Create the radio buttons
        self.top_grid_layout.addWidget(self._samp_rate_0_tool_bar)
        ...
        self._pdu_length_range = Range(0, 2500, 1, 1500, 200)
        ...
        self.foo_packet_pad2_0 = foo.packet_pad2(False, True, 10, 100, 1000)
        ...
        self.blocks_message_strobe_0_0 = blocks.message_strobe(pmt.intern(str(['a' for i in range(20)])), interval)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/hfc/Desktop/tx_hfc', True, 0, 0)
    ...
    def set_gain(self, gain):
        self.gain = gain
        self.uhd_usrp_sink_0_1.set_normalized_gain(self.gain, 0)
